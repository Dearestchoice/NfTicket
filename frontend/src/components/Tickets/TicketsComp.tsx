...
const TicketsComp = ({ ticketsData }: { ticketsData: string[] }) => {
  ...
  return (
    <div className="flex flex-col gap-4">
      <div
        className={`mx-auto w-full grid gap-3 items-start grid-cols-1 sm:grid-cols-${mdGrid(ticketsData)} lg:grid-cols-${lgGrid(ticketsData)} px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-14`}
      >
